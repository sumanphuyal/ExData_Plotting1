...
plot(finalSubsection$DateTime, finalSubsection$Global_active_power, typ="l", 
     ylab = "Global Activity Power", xlab = "")
...
#Third Chart
plot(finalSubsection$DateTime, finalSubsection$Voltage, typ="l", 
     ylab = "Voltage", xlab = "datetime")

#Fourth Chart
plot(finalSubsection$DateTime, finalSubsection$Global_reactive_power, typ="l", 
